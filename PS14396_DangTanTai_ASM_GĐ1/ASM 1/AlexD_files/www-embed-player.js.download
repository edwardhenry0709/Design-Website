...
p("String.prototype.startsWith",function(a){return a?a:function(b,c){var d=oa(this,b,"startsWith");b+="";for(var e=d.length,f=b.length,h=Math.max(0,Math.min(c|0,d.length)),g=0;g<f&&h<e;)if(d[h++]!=b[g++])return!1;return g>=f}});
...
p("WeakMap",function(a){function b(k){this.f=(g+=Math.random()+1).toString();if(k){k=r(k);for(var l;!(l=k.next()).done;)l=l.value,this.set(l[0],l[1])}}
function c(){}
...
return b});
p("Map",function(a){function b(){var g={};return g.previous=g.next=g.head=g}
function c(g,k){var l=g.f;return ea(function(){if(l){for(;l.head!=g.f;)l=l.previous;for(;l.next!=l.head;)return l=l.next,{done:!1,value:k(l)};l=null}return{done:!0,value:void 0}})}
function d(g,k){var l=k&&typeof k;"object"==l||"function"==l?f.has(k)?l=f.get(k):(l=""+ ++h,f.set(k,l)):l="p_"+k;var n=g.g[l];if(n&&w(g.g,l))for(var q=0;q<n.length;q++){var v=n[q];if(k!==k&&v.key!==v.key||k===v.key)return{id:l,list:n,index:q,u:v}}return{id:l,list:n,index:-1,u:void 0}}
function e(g){this.g={};this.f=b();this.size=0;if(g){g=r(g);for(var k;!(k=g.next()).done;)k=k.value,this.set(k[0],k[1])}}
...
var f=new WeakMap;e.prototype.set=function(g,k){g=0===g?0:g;var l=d(this,g);l.list||(l.list=this.g[l.id]=[]);l.u?l.u.value=k:(l.u={next:this.f,previous:this.f.previous,head:this.f,key:g,value:k},l.list.push(l.u),this.f.previous.next=l.u,this.f.previous=l.u,this.size++);return this};
...
p("Object.entries",function(a){return a?a:function(b){var c=[],d;for(d in b)w(b,d)&&c.push([d,b[d]]);return c}});
p("String.prototype.includes",function(a){return a?a:function(b,c){return-1!==oa(this,b,"includes").indexOf(b,c||0)}});
p("Set",function(a){function b(c){this.f=new Map;if(c){c=r(c);for(var d;!(d=c.next()).done;)this.add(d.value)}this.size=this.f.size}
...
b.call(void 0,g,h,a)&&(d[e++]=g)}return d},Ja=Array.prototype.map?function(a,b){return Array.prototype.map.call(a,b,void 0)}:function(a,b){for(var c=a.length,d=Array(c),e="string"===typeof a?a.split(""):a,f=0;f<c;f++)f in e&&(d[f]=b.call(void 0,e[f],f,a));
...
function Oa(a,b){for(var c=1;c<arguments.length;c++){var d=arguments[c];if(xa(d)){var e=a.length||0,f=d.length||0;a.length=e+f;for(var h=0;h<f;h++)a[e+h]=d[h]}else a.push(d)}}
...
function ic(a,b,c){var d=arguments,e=document,f=String(d[0]),h=d[1];if(!cc&&h&&(h.name||h.type)){f=["<",f];h.name&&f.push(' name="',Ab(h.name),'"');if(h.type){f.push(' type="',Ab(h.type),'"');var g={};$a(g,h);delete g.type;h=g}f.push(">");f=f.join("")}f=jc(e,f);h&&("string"===typeof h?f.className=h:Array.isArray(h)?f.className=h.join(" "):gc(f,h));2<d.length&&kc(e,f,d);return f}
...
function b(q){for(var v=h,t=0;64>t;t+=4)v[t/4]=q[t]<<24|q[t+1]<<16|q[t+2]<<8|q[t+3];for(t=16;80>t;t++)q=v[t-3]^v[t-8]^v[t-14]^v[t-16],v[t]=(q<<1|q>>>31)&4294967295;q=e[0];var F=e[1],W=e[2],ha=e[3],Gc=e[4];for(t=0;80>t;t++){if(40>t)if(20>t){var Ha=ha^F&(W^ha);var Cb=1518500249}else Ha=F^W^ha,Cb=1859775393;else 60>t?(Ha=F&W|ha&(F|W),Cb=2400959708):(Ha=F^W^ha,Cb=3395469782);Ha=((q<<5|q>>>27)&4294967295)+Ha+Gc+Cb+v[t]&4294967295;Gc=ha;ha=W;W=(F<<30|F>>>2)&4294967295;F=q;q=Ha}e[0]=e[0]+q&4294967295;e[1]=
e[1]+F&4294967295;e[2]=e[2]+W&4294967295;e[3]=e[3]+ha&4294967295;e[4]=e[4]+Gc&4294967295}
function c(q,v){if("string"===typeof q){q=unescape(encodeURIComponent(q));for(var t=[],F=0,W=q.length;F<W;++F)t.push(q.charCodeAt(F));q=t}v||(v=q.length);t=0;if(0==l)for(;t+64<v;)b(q.slice(t,t+64)),t+=64,n+=64;for(;t<v;)if(f[l++]=q[t++],n++,64==l)for(l=0,b(f);t+64<v;)b(q.slice(t,t+64)),t+=64,n+=64}
function d(){var q=[],v=8*n;56>l?c(g,56-l):c(g,64-(l-56));for(var t=63;56<=t;t--)f[t]=v&255,v>>>=8;b(f);for(t=v=0;5>t;t++)for(var F=24;0<=F;F-=8)q[v++]=e[t]>>F&255;return q}
for(var e=[],f=[],h=[],g=[128],k=1;64>k;++k)g[k]=0;var l,n;a();return{reset:a,update:c,digest:d,xa:function(){for(var q=d(),v="",t=0;t<q.length;t++)v+="0123456789ABCDEF".charAt(Math.floor(q[t]/16))+"0123456789ABCDEF".charAt(q[t]%16);return v}}}
;function Bc(a,b,c){var d=[],e=[];if(1==(Array.isArray(c)?2:1))return e=[b,a],H(d,function(g){e.push(g)}),Cc(e.join(" "));
var f=[],h=[];H(c,function(g){h.push(g.key);f.push(g.value)});
c=Math.floor((new Date).getTime()/1E3);e=0==f.length?[c,b,a]:[f.join(":"),c,b,a];H(d,function(g){e.push(g)});
a=Cc(e.join(" "));a=[c,a];0==h.length||a.push(h.join(""));return a.join("_")}
...
var Kc;
function Lc(){var a=x.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&!J("Presto")&&(a=function(){var e=jc(document,"IFRAME");e.style.display="none";document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.close();var h="callImmediate"+Math.random(),g="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=B(function(k){if(("*"==g||k.origin==g)&&k.data==h)this.port1.onmessage()},this);
...
m.clear=function(){this.h={};this.G=this.g=this.f.length=0};
m.remove=function(a){return Object.prototype.hasOwnProperty.call(this.h,a)?(delete this.h[a],this.g--,this.G++,this.f.length>2*this.g&&id(this),!0):!1};
...
m.set=function(a,b){Object.prototype.hasOwnProperty.call(this.h,a)||(this.g++,this.f.push(a),this.G++);this.h[a]=b};
...
m.F=function(a){id(this);var b=0,c=this.G,d=this,e=new cd;e.next=function(){if(c!=d.G)throw Error("The map has changed since the iterator was created");if(b>=d.f.length)throw bd;var f=d.f[b++];return a?f:d.h[f]};
...
function wd(a,b,c,d){var e=ud(null,null,null);e.f=new O(function(f,h){e.g=b?function(g){try{var k=b.call(d,g);f(k)}catch(l){h(l)}}:f;
e.onRejected=c?function(g){try{var k=c.call(d,g);void 0===k&&g instanceof yd?h(g):f(k)}catch(l){h(l)}}:h});
e.f.h=a;Cd(a,e);return e.f}
O.prototype.A=function(a){this.f=0;rd(this,2,a)};
O.prototype.C=function(a){this.f=0;rd(this,3,a)};
function rd(a,b,c){if(0==a.f){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.f=1;a:{var d=c,e=a.A,f=a.C;if(d instanceof O){Cd(d,ud(e||ua,f||null,a));var h=!0}else if(qd(d))d.then(e,f,a),h=!0;else{if(ya(d))try{var g=d.then;if(A(g)){Ed(d,g,e,f,a);h=!0;break a}}catch(k){f.call(a,k);h=!0;break a}h=!1}}h||(a.m=c,a.f=b,a.h=null,Dd(a),3!=b||c instanceof yd||Fd(a,c))}}
...
m.O=function(a){var b=this.f[a];if(b){var c=this.h[b];0!=this.j?(this.i.push(a),this.f[a+1]=ua):(c&&Ma(c,a),delete this.f[a],delete this.f[a+1],delete this.f[a+2])}return!!b};
m.N=function(a,b){var c=this.h[a];if(c){for(var d=Array(arguments.length-1),e=1,f=arguments.length;e<f;e++)d[e-1]=arguments[e];if(this.m)for(e=0;e<c.length;e++){var h=c[e];Jd(this.f[h+1],this.f[h+2],d)}else{this.j++;try{for(e=0,f=c.length;e<f;e++)h=c[e],this.f[h+1].apply(this.f[h+2],d)}finally{if(this.j--,0<this.i.length&&0==this.j)for(;c=this.i.pop();)this.O(c)}}return 0!=e}return!1};
function Jd(a,b,c){Pc(function(){a.apply(b,c)})}
m.clear=function(a){if(a){var b=this.h[a];b&&(H(b,this.O,this),delete this.h[a])}else this.f.length=0,this.h={}};
m.o=function(){P.M.o.call(this);this.clear();this.i.length=0};function Kd(a){this.f=a}
...
m.F=function(a){var b=0,c=this.f,d=new cd;d.next=function(){if(b>=c.length)throw bd;var e=c.key(b++);if(a)return e;e=c.getItem(e);if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
return d};
...
m.F=function(a){var b=0,c=this.f.XMLDocument.documentElement.attributes,d=new cd;d.next=function(){if(b>=c.length)throw bd;var e=c[b++];if(a)return decodeURIComponent(e.nodeName.replace(/\./g,"%")).substr(1);e=e.nodeValue;if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
return d};
...
;function ke(a){a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length)try{var f=decodeURIComponent((e[0]||"").replace(/\+/g," ")),h=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?Array.isArray(b[f])?Oa(b[f],h):b[f]=[b[f],h]:b[f]=h}catch(k){if("q"!=e[0]){var g=Error("Error decoding URL component");g.params={key:e[0],value:e[1]};ie(g)}}}return b}
function le(a){var b=[];Qa(a,function(c,d){var e=encodeURIComponent(String(d)),f;Array.isArray(c)?f=c:f=[c];H(f,function(h){""==h?b.push(e):b.push(e+"="+encodeURIComponent(String(h)))})});
return b.join("&")}
...
function se(a){var b=a.f;try{var c=b.screenX;var d=b.screenY}catch(q){}try{var e=b.outerWidth;var f=b.outerHeight}catch(q){}try{var h=b.innerWidth;var g=b.innerHeight}catch(q){}b=[b.screenLeft,b.screenTop,c,d,b.screen?b.screen.availWidth:void 0,b.screen?b.screen.availTop:void 0,e,f,h,g];c=a.f.top;try{var k=(c||window).document,l="CSS1Compat"==k.compatMode?k.documentElement:k.body;var n=(new ec(l.clientWidth,l.clientHeight)).round()}catch(q){n=new ec(-12245933,-12245933)}k=n;n={};l=new Ec;x.SVGElement&&
...
function De(a){var b=window.location.search,c=K(L(3,a)),d=K(L(5,a));d=(c=c&&(c.endsWith("youtube.com")||c.endsWith("youtube-nocookie.com")))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=me(b),f={};H(ze,function(h){e[h]&&(f[h]=e[h])});
return oe(a,f||{},!1)}
function Ce(a,b){var c=R("CORS_HEADER_WHITELIST")||{},d=K(L(3,a));return d?(c=c[d])?0<=Ga(c,b):!1:!0}
function Ee(a,b){if(window.fetch&&"XML"!=b.format){var c={method:b.method||"GET",credentials:"same-origin"};b.headers&&(c.headers=b.headers);a=Fe(a,b);var d=Ge(a,b);d&&(c.body=d);b.withCredentials&&(c.credentials="include");var e=!1,f;fetch(a,c).then(function(h){if(!e){e=!0;f&&U(f);var g=h.ok,k=function(l){l=l||{};var n=b.context||x;g?b.onSuccess&&b.onSuccess.call(n,l,h):b.onError&&b.onError.call(n,l,h);b.ja&&b.ja.call(n,l,h)};
...
function He(a,b){var c=b.format||"JSON";a=Fe(a,b);var d=Ge(a,b),e=!1,f=Ie(a,function(k){if(!e){e=!0;g&&U(g);var l=xe(k),n=null,q=400<=k.status&&500>k.status,v=500<=k.status&&600>k.status;if(l||q||v)n=Je(c,k,b.ob);if(l)a:if(k&&204==k.status)l=!0;else{switch(c){case "XML":l=0==parseInt(n&&n.return_code,10);break a;case "RAW":l=!0;break a}l=!!n}n=n||{};q=b.context||x;l?b.onSuccess&&b.onSuccess.call(q,k,n):b.onError&&b.onError.call(q,k,n);b.ja&&b.ja.call(q,k,n)}},b.method,d,b.headers,b.responseType,b.withCredentials);
if(b.P&&0<b.timeout){var h=b.P;var g=T(function(){e||(e=!0,f.abort(),U(g),h.call(b.context||x,f))},b.timeout)}return f}
...
function Ge(a,b){var c=R("XSRF_FIELD_NAME",void 0),d=R("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.B,h=R("XSRF_FIELD_NAME",void 0),g;b.headers&&(g=b.headers["Content-Type"]);b.qb||K(L(3,a))&&!b.withCredentials&&K(L(3,a))!=document.location.hostname||"POST"!=b.method||g&&"application/x-www-form-urlencoded"!=g||b.B&&b.B[h]||(f||(f={}),f[c]=d);f&&"string"===typeof e&&(e=me(e),$a(e,f),e=b.ra&&"JSON"==b.ra?JSON.stringify(e):Fb(e));f=e||f&&!Ua(f);!Ae&&f&&"POST"!=b.method&&(Ae=!0,ie(Error("AJAX request with postData should use POST")));
return e}
...
return b}
function Ie(a,b,c,d,e,f,h){function g(){4==(k&&"readyState"in k?k.readyState:0)&&b&&he(b)(k)}
c=void 0===c?"GET":c;d=void 0===d?"":d;var k=we();if(!k)return null;"onloadend"in k?k.addEventListener("loadend",g,!1):k.onreadystatechange=g;S("debug_forward_web_query_parameters")&&(a=De(a));k.open(c,a,!0);f&&(k.responseType=f);h&&(k.withCredentials=!0);c="POST"==c&&(void 0===window.FormData||!(d instanceof FormData));if(e=Be(a,e))for(var l in e)k.setRequestHeader(l,e[l]),"content-type"==l.toLowerCase()&&(c=!1);c&&k.setRequestHeader("Content-Type","application/x-www-form-urlencoded");k.send(d);
return k}
;var Ne={},Oe=0;
...
function Ye(a,b,c,d){d=void 0===d?{}:d;a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return Sa(function(e){var f="boolean"===typeof e[4]&&e[4]==!!d,h=ya(e[4])&&ya(d)&&Wa(e[4],d);return!!e.length&&e[0]==a&&e[1]==b&&e[2]==c&&(f||h)})}
var Ze=Pa(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
window.addEventListener("test",null,b)}catch(c){}return a});
function V(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=Ye(a,b,c,d);if(e)return e;e=++Xe.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var h=f?function(g){g=new Ve(g);if(!mc(g.relatedTarget,function(k){return k==a}))return g.currentTarget=a,g.type=b,c.call(a,g)}:function(g){g=new Ve(g);
g.currentTarget=a;return c.call(a,g)};
h=he(h);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),Ze()||"boolean"===typeof d?a.addEventListener(b,h,d):a.addEventListener(b,h,!!d.capture)):a.attachEvent("on"+b,h);Ta[e]=[a,b,c,h,d];return e}
...
try{pf[a]?f():T(f,0)}catch(h){ie(h)}},void 0);
...
function Kf(a){var b=Bf,c=Math.round(X());a=r(a);for(var d=a.next();!d.done;d=a.next()){var e=r(d.value);d=e.next().value;var f=e.next().value;e=Ya({context:Mf(b.f||Nf())});e.events=f;(f=If[d])&&Of(e,d,f);delete If[d];Pf(e,c);Qf(b,"log_event",e,{retry:!0,onSuccess:function(){Af=Math.round(X()-c)}});
Ff=!1}}
...
;function Tf(){for(var a={},b=r(Object.entries(me(R("DEVICE","")))),c=b.next();!c.done;c=b.next()){var d=r(c.value);c=d.next().value;d=d.next().value;"cbrand"===c?a.deviceMake=d:"cmodel"===c?a.deviceModel=d:"cbr"===c?a.browserName=d:"cbrver"===c?a.browserVersion=d:"cos"===c?a.osName=d:"cosver"===c?a.osVersion=d:"cplatform"===c&&(a.platform=d)}return a}
...
;function cg(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];d=Error.call(this,a);this.message=d.message;"stack"in d&&(this.stack=d.stack);this.args=[].concat(c instanceof Array?c:fa(r(c)))}
...
qa:d.P,onSuccess:function(v,t){if(d.onSuccess)d.onSuccess(t)},
...
timeout:d.timeout,withCredentials:!0},f="",h=a.f.Ha;h&&(f=h);h=a.f.Ia||!1;var g=Vf(h,f,d);Object.assign(e.headers,g);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var k=ne(""+f+("/youtubei/"+a.f.innertubeApiVersion+"/"+b),{alt:"json",key:a.f.innertubeApiKey}),l;if(d.retry&&S("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=$f(b,c,g,h))){var n=e.onSuccess,q=e.oa;e.onSuccess=function(v,t){ag(l);n(v,t)};
c.oa=function(v,t){ag(l);q(v,t)}}try{S("use_fetch_for_op_xhr")?Ee(k,e):(e.method="POST",e.B||(e.B={}),He(k,e))}catch(v){if("InvalidAccessError"==v.name)l&&(ag(l),l=0),je(Error("An extension is blocking network request."));
...
window.yterr||f)&&!(5<=gg)&&0!==a.f)){f=a.g;if(a.args&&a.args.length)for(var h=0,g=0;g<a.args.length;g++){d=a.args[g];e="params."+g;h+=e.length;if(d)if(Array.isArray(d))for(var k=c,l=0;l<d.length&&!(d[l]&&(h+=jg(l,d[l],e,k),500<h));l++);else if("object"===typeof d)for(k in k=void 0,l=c,d){if(d[k]&&(h+=jg(k,d[k],e,l),500<h))break}else c[e]=String(JSON.stringify(d)).substring(0,500),h+=c[e].length;else c[e]=String(JSON.stringify(d)).substring(0,500),h+=c[e].length;if(500<=h)break}else if(a.hasOwnProperty("params"))if(d=
a.params,"object"===typeof a.params)for(g in e=0,d){if(d[g]&&(h="params."+g,k=String(JSON.stringify(d[g])).substr(0,500),c[h]=k,e+=h.length+k.length,500<e))break}else c.params=String(JSON.stringify(d)).substr(0,500);g=Zb(a);c={message:g.message||"Unknown Error",name:g.name||"UnknownError",lineNumber:g.lineNumber||"Not available",fileName:g.fileName||"Not available",stack:g.stack||"Not available",params:c};(f=f||c.stack)||(f="Not available");g=Number(a.columnNumber);a=Number(a.lineNumber);isNaN(a)||
isNaN(g)||(c.lineNumber=a+":"+g);window.yterr&&A(window.yterr)&&window.yterr(c);if(!(fg.has(c.message)||0<=f.indexOf("/YouTubeCenter.js")||0<=f.indexOf("/mytube.js"))){if(S("kevlar_gel_error_routing")){f=b;g={stackTrace:c.stack};c.fileName&&(g.filename=c.fileName);a=c.lineNumber.split(":");0!==a.length&&(1!==a.length||isNaN(Number(a[0]))?2!==a.length||isNaN(Number(a[0]))||isNaN(Number(a[1]))||(g.lineNumber=Number(a[0]),g.columnNumber=Number(a[1])):g.lineNumber=Number(a[0]));a={level:"ERROR_LEVEL_UNKNOWN",
message:c.message};"ERROR"===f?a.level="ERROR_LEVEL_ERROR":"WARNING"===f&&(a.level="ERROR_LEVEL_WARNNING");f={isObfuscated:!0,browserStackInfo:g};g={pageUrl:window.location.href,kvPairs:[]};if(d=c.params)for(e=r(Object.keys(d)),h=e.next();!h.done;h=e.next())h=h.value,g.kvPairs.push({key:"client."+h,value:String(d[h])});eg("clientError",{errorMetadata:g,stackTrace:f,logMessage:a});Jf()}a=c.params||{};b={Ya:{a:"logerror",t:"jserror",type:c.name,msg:c.message.substr(0,250),line:c.lineNumber,level:b,
"client.name":a.name},B:{url:R("PAGE_NAME",window.location.href),file:c.fileName},method:"POST"};a.version&&(b["client.version"]=a.version);if(b.B){c.stack&&(b.B.stack=c.stack);f=r(Object.keys(a));for(g=f.next();!g.done;g=f.next())g=g.value,b.B["client."+g]=a[g];if(a=R("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(f=r(Object.keys(a)),g=f.next();!g.done;g=f.next())g=g.value,b.B[g]=a[g];a=R("SERVER_NAME",void 0);f=R("SERVER_VERSION",void 0);a&&f&&(b.B["server.name"]=a,b.B["server.version"]=
f)}He(R("ECATCHER_REPORT_HOST","")+"/error_204",b);fg.add(c.message);gg++}}}
...
function ug(a,b,c){c=void 0===c?null:c;var d=vg(a),e=document.getElementById(d),f=e&&pg(e,"loaded"),h=e&&!f;f?b&&b():(b&&(f=qf(d,b),b=""+za(b),wg[b]=f),h||(e=xg(a,d,function(){pg(e,"loaded")||(ng(e),tf(d),T(Ea(uf,d),0))},c)))}
...
Eg.prototype.initialize=function(a,b,c,d,e,f){var h=this;f=void 0===f?!1:f;b?(this.g=!0,tg(b,function(){h.g=!1;window.botguard?Fg(h,c,d,f):(yg(b),hg(new cg("Unable to load Botguard","from "+b)))},e)):a&&(eval(a),window.botguard?Fg(this,c,d,f):hg(Error("Unable to load Botguard from JS")))};
...
y("yt_logging_screen.setCurrentScreen",bh,void 0);function ch(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=R("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=R("VALID_SESSION_TEMPDATA_DOMAINS",[]),h=K(L(3,window.location.href));h&&f.push(h);h=K(L(3,d));if(0<=Ga(f,h)||!h&&0==d.lastIndexOf("/",0))if(S("autoescape_tempdata_url")&&(f=document.createElement("a"),yb(f,d),d=f.href),d){h=d.match(Db);d=h[5];f=h[6];h=h[7];var g="";d&&(g+=d);f&&(g+="?"+f);h&&(g+="#"+h);d=g;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||
b.ved)&&(b=Object.assign({csn:Zg()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Bb(d).toString(36),e=e?Fb(e):"",Xf(b,e,k||5))}else k=b,e="ST-"+Bb(d).toString(36),k=k?Fb(k):"",Xf(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var n=void 0===n?"":n;var q=void 0===q?window:q;c=q.location;a=Gb(a,l)+n;a=a instanceof I?a:rb(a);c.href=pb(a)}return!0}
...
function lh(a){var b=mh,c=kh();if(!c)return 0;var d=c.subscribe(b.toString(),function(e,f){var h=z("ytPubsub2Pubsub2SkipSubKey");h&&h==d||(h=function(){if(gh[d])try{if(f&&b instanceof eh&&b!=e)try{var g=b.f,k=f;if(!k.args||!k.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");try{if(!g.G){var l=new g;g.G=l.version}var n=g.G}catch(q){}if(!n||k.version!=n)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");try{f=Reflect.construct(g,
Na(k.args))}catch(q){throw q.message="yt.pubsub2.Data.deserialize(): "+q.message,q;}}catch(q){throw q.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+q.message,q;}a.call(window,f)}catch(q){ie(q)}},ih[b.toString()]?z("yt.scheduler.instance")?df(h):T(h,0):h())});
...
c=r(c);for(var e=c.next();!e.done;e=c.next())e=Tg(e.value),(Ua(e)||!e.trackingParams&&!e.veType)&&kg(Error("Child VE logged with no data"),"WARNING");c={da:ah(a),R:a};"UNDEFINED_CSN"==a?uh("visualElementAttached",b,c):d?Sf("visualElementAttached",b,d,c):eg("visualElementAttached",b,c)}
function uh(a,b,c){rh.push({payloadName:a,payload:b,options:c});sh||(sh=nh())}
function oh(a){if(rh){for(var b=r(rh),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,Sf(c.payloadName,c.payload,null,c.options));rh.length=0}sh=0}
...
u(Ch,N);m=Ch.prototype;m.getId=function(){return this.V};
m.loadNewVideoConfig=function(a){if(!this.g){this.U&&(U(this.U),this.U=0);a instanceof vh||(a=new vh(a));this.ca=a;this.f=a.clone();Eh(this);this.X||(this.X=Gh(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.m.style.width=xc(Number(a)||a);if(a=this.f.attrs.height)this.m.style.height=xc(Number(a)||a);Fh(this);this.A&&Hh(this)}};
...
m.aa=function(a,b){var c=this,d=Gh(this,b);if(d){if(!(0<=Ga(this.ua,a)||this.j[a])){var e=Qh(this,a);this.H&&this.H(a,e)}this.I.subscribe(a,d);"onReady"==a&&this.A&&T(function(){d(c.api)},0)}};
m.Pa=function(a,b){if(!this.g){var c=Gh(this,b);c&&Id(this.I,a,c)}};
...
function Qh(a,b){var c="ytPlayer"+b+a.V;a.j[b]=c;x[c]=function(d){var e=T(function(){if(!a.g){a.I.N(b,d);var f=a.T,h=String(e);h in f&&delete f[h]}},0);
Va(a.T,String(e))};
return c}
m.wa=function(a){tf("a11y-announce",a)};
m.Ka=function(a){tf("WATCH_LATER_VIDEO_ADDED",a)};
m.La=function(a){tf("WATCH_LATER_VIDEO_REMOVED",a)};
m.Ba=function(){return this.S||(Jh(this)?"html5":null)};
...
m.cancel=function(){if(this.C){var a=Kh(this);zg(a,this.C)}U(this.ka);this.J=!1};
m.o=function(){Mh(this);if(this.l&&this.f&&this.l.destroy)try{this.l.destroy()}catch(b){ie(b)}this.Z=null;for(var a in this.j)x[this.j[a]]=null;this.ca=this.f=this.api=null;delete this.Y;delete this.m;N.prototype.o.call(this)};
...
m.Ra=function(a,b){this.j&&!this.g&&$h(this.f,a,this.fa(a,b))};
m.fa=function(a,b){if(null!=b)return{value:b}};
function bi(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
m.o=function(){var a=this.f;a.g||Id(a.f,"command",this.sa,this);this.f=null;for(var b in this.h)bi(this,b);N.prototype.o.call(this)};function ei(a,b){ai.call(this,b);this.i=a;this.start()}
...
ei.prototype.o=function(){ai.prototype.o.call(this);delete this.i};function fi(a,b,c){N.call(this);var d=this;c=c||R("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.A="*";this.i=c;this.sessionId=null;this.channel="widget";this.C=!!a;this.m=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(h){break a}if(!(null==f||d.C&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
m=gi.prototype;m.Oa=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,hi(this,a)),this.j[a]=!0)):this.na(a,b,c)};
m.na=function(){};
function hi(a,b){return B(function(c){this.sendMessage(b,c)},a)}
m.addEventListener=function(){};
m.ya=function(){this.l=!0;this.sendMessage("initialDelivery",this.ga());this.sendMessage("onReady");H(this.i,this.ta,this);this.i=[]};
...
m.Va=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:C()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());ii(this,a)};
m.Xa=function(){var a={sphericalProperties:this.f.getSphericalProperties()};ii(this,a)};
m.dispose=function(){gi.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function ki(a,b,c){N.call(this);this.f=a;this.i=c;this.j=V(window,"message",B(this.l,this));this.h=new Zh(this,a,b);uc(this,Ea(vc,this.h))}
...
c=r(c);for(d=c.next();!d.done;d=c.next())Fi(a,d.value);return a}
...
function Hi(a,b){for(var c=r(b),d=c.next();!d.done;d=c.next())d=d.value,Ei(d)?a.push(Fi({},d)):Gi(d)?a.push(Hi([],d)):a.push(d);return a}
...
(f=R((c||"")+"TIMING_ACTION",void 0),e=Ri(c),z("ytglobal.timing"+(c||"")+"ready_")&&f&&kj("_start")&&Qi(c)))if(Vi(c),c)lj(c);else{f=!0;var h=R("TIMING_WAIT",[]);if(h.length)for(var g=0,k=h.length;g<k;++g)if(!(h[g]in e)){f=!1;break}f&&lj(c)}Xi(c||"").tick[a]=b||X()}return d[a]}
function kj(a,b){var c=Ri(b);return a in c}
function lj(a){if(!gj(a)){var b=Ri(a),c=Ti(a),d=b._start,e=R("CSI_SERVICE_NAME","youtube"),f={v:2,s:e,action:R((a||"")+"TIMING_ACTION",void 0)},h=c.srt;void 0!==b.srt&&delete c.srt;b.aft=Qi(a);var g=Ri(a),k=g.pbr,l=g.vc;g=g.pbs;k&&l&&g&&k<l&&l<g&&Ti(a).yt_pvis&&"youtube"===e&&(ij("yt_lt","hot_bg",a),e=b.vc,k=b.pbs,delete b.aft,c.aft=Math.round(k-e));for(var n in c)"_"!==n.charAt(0)&&(f[n]=c[n]);b.ps=X();n={};e=[];for(var q in b)"_"!==q.charAt(0)&&(k=Math.round(b[q]-d),n[q]=k,e.push(q+"."+k));f.rt=
e.join(",");b=!!c.ap;S("debug_csi_data")&&(c=z("yt.timing.csiData"),c||(c=[],D("yt.timing.csiData",c)),c.push({page:location.href,time:new Date,args:f}));c="";for(var v in f)f.hasOwnProperty(v)&&(c+="&"+v+"="+f[v]);f="/csi_204?"+c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var t=void 0===t?"":t;Se(f,t)||Pe(f,void 0,void 0,void 0,t)}else Pe(f);y("yt.timing."+(a||"")+"pingSent_",!0,void 0);jh(Li,new Ji(n.aft+(Number(h)||0),a))}}
...
function vj(a){a=a.ids;var b=Zg();if(b)for(var c=0;c<a.length;c++){var d=qj[a[c]];if(d){var e=b,f=S("use_default_events_client")?void 0:dg;d={csn:e,ve:Tg(d),eventType:1};var h={da:ah(e),R:e};"UNDEFINED_CSN"==e?uh("visualElementShown",d,h):f?Sf("visualElementShown",d,f,h):eg("visualElementShown",d,h)}}}
